    ...
    <div className="grid-background min-h-screen text-primary">
      <section className="relative z-10 flex flex-col" id="Home">
        ...
        <div className="flex flex-col justify-center items-center pt-20 text-center">
          ...
          <p className="m-auto w-[50%] pt-7 text-primary">Organize your life beautifully, collaborate effortlessly, and never lose track of what matters. A mindful approach to productivity that respects your time and energy.</p>
